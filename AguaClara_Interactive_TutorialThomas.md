M# AguaClara Interactive Tutorial
...
![Reading Massachusetts](https://github.com/tsb49/Personal/blob/Images/Images/ReadingMA.jpg?raw=true)
...
|:--------------- |:--------------: |--------------: |:--------------- |
|Corgi                 | Bacon                |Lord of the Rings                |  Home               |
...
1. Below this, I've copied the code I wrote for the [Python Basics Tutoria l](https://github.com/AguaClara/aguaclara_tutorial/wiki/Tutorial:-Python-Basics). You should familiarize yourself with the different Hydrogen commands using this code. For the first line, use `Hydrogen: Run` (`Cmnd + Enter`).
